...
## Feature: Task Status History & UI (Current)
- [x] Создать таблицу taskStatusHistory в БД для логирования изменений
- [x] Добавить процедуру logTaskStatusChange в routers
- [x] Обновить процедуру updateTaskStatus для логирования изменений
- [x] Добавить галочку в деталях задачи (TaskDetail.tsx)
- [x] Отображать историю изменений статуса в деталях задачи
- [x] Все 35 тестов проходят

## Fixes: Task Status & UI (Current)
- [x] Исправить ошибку при установке галочки завершения (добавить оптимистичное обновление)
- [x] Убрать блок с объяснением приоритетов из Tasks.tsx
- [x] Адаптировать фильтр задач под мобильные экраны
- [x] Все 35 тестов проходят

## Fixes: Task Status & Search (Current)
- [x] Исправить оптимистичное обновление галочки в TaskDetail (добавить обновление getTaskById)
- [x] Перенести поиск заметок из сайдбара в страницу Мои заметки
- [x] Все 35 тестов проходят
