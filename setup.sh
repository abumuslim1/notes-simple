...
echo ""
echo "3. Перейдите на страницу Лицензии и скопируйте Server ID"
echo ""
echo "4. Используйте скрипт для генерации лицензионного ключа:"
echo "   python3 license_generator.py"
echo ""
echo "5. Активируйте лицензию на странице Лицензии"
echo ""
